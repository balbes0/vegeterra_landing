...
const benefits = [
    {imageURL: "/assets/images/benefits-strawberry.png", description: "Представьте: ранее утро в уютном доме бабушки, тёплая кухня, свежие ягоды и овощи — только что с грядки." +
            "\n\n Вкус — насыщенный и яркий, тот самый, который остаётся в памяти с детства. Забота и любовь чувствовались в каждом кусочке. "},
    {imageURL: "/assets/images/benefits-greenhouse.png", description: "Именно эти воспоминания вдохновили нас создать ВЕГЕТЕРРА — инновационный агроэкохолдинг. " +
